        ...
        <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="#DN">Manage Site</a>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5 class="card-title"><u>UNDER PROGRESS</u></h5>
                            </div>
                            <div class="card-body">
                                <h2> <p class="description blockquote blockquote-danger"> The page is still under development!!</p></h2>
                            </div>
