...
<!--Side bar-->
		...
		<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
			<div class="sidebar-nav text-danger">
						   ...
						   <form  method="POST" action="#.php">
								<div class="col-xs-12 col-sm-12">
					            	...
					            	<div class="form-group">
					            		<div class="row">
					            			<div class="col-xs-12 col sm-12">
					            				<label class="control-label text-danger" for="from">Check In</label>
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
					            				<label class="control-label text-danger" for="to">Check Out</label>
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
						           				 <button type="submit" class="btn btn-info" align="right"name="avail">Check Availability</button>
						           			 </div>
						            	</div>
						            </div>
						        </div>
