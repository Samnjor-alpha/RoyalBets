...
<title>Royal Guest House: <?php echo $title; ?></title>
...
<nav class=<"navbar navbar-expand-1g navbar-light"style="background-color:#00ff00"role">
...
body {background:yellow ! important;}
	          ...
	          <a class="navbar-brand text-danger" href="<?php echo WEB_ROOT; ?>index.php">Royal Guest House</a>
	        </div>
