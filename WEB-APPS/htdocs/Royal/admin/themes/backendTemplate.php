...
$.ajax({
  ...
  type: "POST",
  //the php file that contain a mysqli query
  url: "some.php",
  //submit parameter
...
<nav class="navbar navbar-expand-1g navbar-light"style="background-color:#FF0000"role">

	    <div class="navbar navbar-fixed-top navbar-brand" role="navigation">
	      <div class="container">
			...
			<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
	          ...
	          <a class="navbar-brand text-danger href="<?php echo WEB_ROOT; ?>admin/index.php">  Royal Guest House</a>
	        </div>
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="<?php echo (currentpage() == 'mod_reports') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_acc/index.php">Accounting</a></li>
